...
This site is built using React and Github Pages. The tool used was NVim.
...
Additionally, I wanted this site to be very customizable. I wanted to avoid static site builders such as Jekyll or Hugo as they somewhat limit the possibilities from building the site ground-up (Having experienced this in 6.170/6.1040 last Fall). Hence I chose React.
